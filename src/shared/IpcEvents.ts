...
export const enum IpcEvents {
    ...
    // Discordmaxxer additions
    DM_REGISTER_GLOBAL_HOTKEY = "DM_REGISTER_GLOBAL_HOTKEY",
    DM_UNREGISTER_GLOBAL_HOTKEY = "DM_UNREGISTER_GLOBAL_HOTKEY",
    DM_GLOBAL_HOTKEY_FIRED = "DM_GLOBAL_HOTKEY_FIRED",
    DM_SET_PERFORMANCE_MODE = "DM_SET_PERFORMANCE_MODE",
    DM_SET_VOICE_ACTIVE = "DM_SET_VOICE_ACTIVE",
